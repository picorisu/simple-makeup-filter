...
- **線・クマの軽減 / Line & dark circle reduction**: ほうれい線・マリオネットライン・目の下の線・クマ。対象領域の楕円のみ強ぼかしのパッチを貼る（領域外は不変）
- **メイク / Makeup**（MediaPipe Face Mesh で顔468点を追跡、動きに追従）
  - リップ / Lip color（濃さ・色・ツヤ・太さ）
  ...
  - シェーディング / Contouring（ノーズ・輪郭。濃さ・幅・位置・ぼかし）
  - ハイライト / Highlight（鼻筋・頬骨・顎先。濃さ・大きさ・位置・ぼかし）
